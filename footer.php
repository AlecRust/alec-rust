...
?>
        ...
        <script>window.jQuery || document.write('<script src="<?php echo get_template_directory_uri(); ?>/assets/js/vendor/jquery-2.0.3.min.js"><\/script>')</script>
        <script src="<?php echo get_template_directory_uri(); ?>/assets/js/main.min.js"></script>

        <?php wp_reset_query(); ?>

        <?php if (is_page('home') ) { ?>
        <script src="<?php echo get_template_directory_uri(); ?>/assets/js/cycle-text.min.js"></script>
        <script>
