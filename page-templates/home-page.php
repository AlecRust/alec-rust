...
get_header(); ?>
    ...
    <section class="module module-thumbs">
        ...
        <ul>
            <li><a href="<?php echo site_url('/work/unicef/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/temp/company-thumb-unicef.png" width="120" height="60" alt="Unicef"></a></li>
